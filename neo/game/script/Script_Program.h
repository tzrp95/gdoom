...
========================================================================
	...
	In-game representation of objects in scripts.  
	Use the idScriptVariable template (below) to access variables.
...
========================================================================
	...
	Helper template that handles looking up script variables stored 
	in objects. If the specified variable doesn't exist, or is the 
	wrong data type, idScriptVariable will cause an error.
...
========================================================================
	...
	These objects will automatically handle looking up of the current
	value of a variable in a script object.  They can be stored as 
	part of a class for up-to-date values of the variable, or can be
	used in functions to sample the data for non-dynamic values.
...
========================================================================
	...
	Causes the compiler to exit out of compiling the current function
	and display an error message with line and file info.
...
========================================================================
	...
	Define the name, type, and location of variables, functions,
	and objects defined in script.
...
========================================================================
	...
	Handles compiling and storage of script data.  Multiple idProgram
	objects would represent seperate programs with no knowledge of
	each other.  Scripts meant to access shared data and functions 
	should all be compiled by a single idProgram.
