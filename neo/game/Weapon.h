...
public:
	...
	bool					PowerupFromWeapon( void ) { return powerUpLaunched; };
	void					BeginSpecialFunction( bool );
	void					EndSpecialFunction( void );
	...
	bool					powerUpLaunched;

protected:
		void				GetModelPosition( idVec3& viewOffset, idAngles& viewAngles ) const;
...
private:
	...
	idScriptBool			WEAPON_SPECIAL;
	idScriptBool			WEAPON_SPECIAL_HOLD;
	...
	// nozzle effects
	bool					nozzleFx;				// does this use nozzle effects ( parm5 at rest, parm6 firing ), also assumes a nozzle light atm
