...
public:
	...
	// added const bool toggleWeapons from DentonMod --->
...
private:
	...
	void					WeaponSpecialFunction( bool keyTapped );	// added from DentonMod
	...
	void					Event_GetImpulseKey( void );	// added from DentonMod
};
